...
//
// Detection uses os/exec to call git on PATH for cases 1 and 2; git must be
// available for those cases to succeed. Cases 0, 3, 4, and 5 are pure-Go
...
// Requires git on PATH; returns "" if git is unavailable or dir is not inside a repo.
...
// always returns a value consistent with stored project names.
